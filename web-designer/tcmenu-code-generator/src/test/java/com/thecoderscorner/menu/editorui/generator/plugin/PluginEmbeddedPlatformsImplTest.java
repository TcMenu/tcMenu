...
class PluginEmbeddedPlatformsImplTest {
    ...
    void testEmbeddedPlatforms() {
        ...
        var codeGenSupplier = new CodeGeneratorSupplier(mock(ConfigurationStorage.class));
        ...
        var generator = codeGenSupplier.getCodeGeneratorFor(ARDUINO_AVR, standardOptions, mock(UserFeedbackLogger.class));
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            ...
            codeGenSupplier.getCodeGeneratorFor(invalidPlatform, standardOptions, mock(UserFeedbackLogger.class));
        });
    }
}