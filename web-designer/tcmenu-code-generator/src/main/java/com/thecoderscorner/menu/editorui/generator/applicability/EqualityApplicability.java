...
public class EqualityApplicability implements CodeApplicability {
    ...
    public static CodeApplicability notMatchingApplicability(String prop, String value) {
        return new EqualityApplicability(prop, value, true);
    }

    public static CodeApplicability matchingApplicability(String prop, String value) {
        return new EqualityApplicability(prop, value, false);
    }
