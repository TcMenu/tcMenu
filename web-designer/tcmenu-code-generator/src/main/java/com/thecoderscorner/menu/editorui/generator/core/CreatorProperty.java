...
public class CreatorProperty {
    ...
    public static CreatorProperty optionalPin(String id, String name, String desc, String defValue, SubSystem ss) {
        return new CreatorProperty(id, name, desc, defValue, ss, PropType.VARIABLE, optPinValidator(), ALWAYS_APPLICABLE);
    }

    public static CreatorProperty optionalPin(String id, String name, String desc, String defValue, SubSystem ss, CodeApplicability applicability) {
        return new CreatorProperty(id, name, desc, defValue, ss, PropType.VARIABLE, optPinValidator(), applicability);
    }
    ...
    /**
     * Make a deep copy of a creator property with the ability to take the value from another uiProperty.
     * @param cp the property to copy from
     * @param uiProp if not null, the value is taken from this properly
     * @return the combined copy
     */
    public static CreatorProperty deepCopy(CreatorProperty cp, CreatorProperty uiProp) {
        var latestValue = uiProp != null ? uiProp.getLatestValue() : cp.getLatestValue();
        return new CreatorProperty(cp.getName(), cp.getDescription(), cp.getExtendedDescription(),
                latestValue, cp.getSubsystem(), cp.getPropType(), cp.getValidationRules(), cp.getApplicability());
    }
