...
public abstract class BaseJavaPluginItem implements JavaPluginItem {
    ...
    protected BaseJavaPluginItem(SubSystem subsystem, String imagePath) {
    ...
    public boolean isImagePng() {
        return imagePath != null && imagePath.endsWith(".png");
    }
    ...
    public Optional<BufferedImage> getImage() {
        try {
            BufferedImage img = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream(imagePath)));
