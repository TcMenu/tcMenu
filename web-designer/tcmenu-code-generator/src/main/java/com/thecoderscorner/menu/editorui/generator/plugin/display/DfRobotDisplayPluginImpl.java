...
public class DfRobotDisplayPluginImpl extends BaseJavaPluginItem {
    ...
    public DfRobotDisplayPluginImpl(JavaPluginGroup group, CodePluginManager manager) {
        super(SubSystem.DISPLAY, "/plugin/display/DfRobotShield.jpg");
        ...
        codePlugin.setDocsLink("https://www.thecoderscorner.com/products/arduino-libraries/tc-menu/tcmenu-plugins/dfrobot-input-display-plugin/");
        ...
        codePlugin.setImageFileName("DfRobotShield.jpg");
        codePlugin.setSupportedPlatforms(PluginEmbeddedPlatformsImpl.arduinoPlatforms);
        codePlugin.setThemeDescription(ThemeDescription.NO_THEME);
    ...
    public List<RequiredSourceFile> getRequiredSourceFiles() {
        ...
        return List.of(
                new RequiredSourceFile("tcMenuLiquidCrystal.cpp", CommonLCDPluginHelper.getSourceCode(isUno), List.of(), true),
                new RequiredSourceFile("tcMenuLiquidCrystal.h", CommonLCDPluginHelper.getHeaderCode(isUno), List.of(), true)
        );
    }
