...
public class GxEPD2SimplePluginImpl extends CommonAdafruitDisplayPlugin {
    ...
    private static final List<String> DEFAULT_COLORS = List.of(
            ...
            "GxEPD_BLUE", "GxEPD_GREEN", "GxEPD_CYAN", "GxEPD_ORANGE"
    );
    ...
    public GxEPD2SimplePluginImpl(JavaPluginGroup group, CodePluginManager manager) {
        super(SubSystem.DISPLAY, "/plugin/display/eink-screen.jpg");
        this.group = group;
    ...
    public List<HeaderDefinition> getHeaderDefinitions() {
        ...
        return List.of(
                ...
                new HeaderDefinition("TcMenuGxEPDeInk.h", HeaderType.SOURCE, 2, ALWAYS_APPLICABLE)
        );
    }
