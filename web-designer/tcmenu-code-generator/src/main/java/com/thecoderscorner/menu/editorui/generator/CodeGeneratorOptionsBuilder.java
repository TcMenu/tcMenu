...
public class CodeGeneratorOptionsBuilder {
    ...
    private EepromSaveMode eepromSaveMode = EepromSaveMode.DYNAMIC_WRITE_BY_ID;
    ...
    public CodeGeneratorOptionsBuilder withEepromSaveMode(EepromSaveMode mode) {
        this.eepromSaveMode = mode;
        return this;
    }
