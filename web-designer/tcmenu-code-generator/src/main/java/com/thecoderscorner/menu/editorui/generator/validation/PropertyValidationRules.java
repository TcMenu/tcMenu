...
/**
 * These rules define how a given {@link com.thecoderscorner.menu.editorui.generator.core.CreatorProperty} can be modified within
...
public interface PropertyValidationRules {
    ...
    /**
     * This gets the information about property validation so that the web UI
     * can apply the right validation rules.
     *
     * @return the validation rules
     */
    PropValidationInfo getValidationInfo();
}
