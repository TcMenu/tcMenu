...
import static com.thecoderscorner.menu.editorui.generator.plugin.theme.InbuiltThemePlugins.USE_TC_UNICODE_PROP_NAME;
...
public class CodeVariableCppExtractor implements CodeVariableExtractor {
    ...
    public void setStartingLevels(int levels) {
        this.levels = levels;
    }
