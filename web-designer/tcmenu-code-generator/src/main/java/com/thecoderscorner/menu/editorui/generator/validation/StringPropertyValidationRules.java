...
import static com.thecoderscorner.menu.editorui.generator.validation.PropValidationInfo.*;
...
public class StringPropertyValidationRules implements PropertyValidationRules {
    ...
    public PropValidationInfo getValidationInfo() {
        var mode = variable ? PropertyValidationMode.VARIABLE : PropertyValidationMode.TEXT;
        return new PropValidationInfo(mode, 0, maxLen, null, List.of());
    }
