...
public class CannedPropertyValidators {
    ...
    public static MenuItemValidationRules menuItemValidatorForAllItems() {
        return new MenuItemValidationRules(MenuItem.class);
    }
     ...
     */    public static MenuItemValidationRules menuItemValidatorForSpecifcType(Class<? extends MenuItem> cls) {
        return new MenuItemValidationRules(cls);
    }
    ...
    private static class EmptyValidationRule implements PropertyValidationRules {
        ...
        public PropValidationInfo getValidationInfo() {
            return new PropValidationInfo(PropValidationInfo.PropertyValidationMode.SEPARATOR, 0, 255, null, List.of());
        }
    }
}
