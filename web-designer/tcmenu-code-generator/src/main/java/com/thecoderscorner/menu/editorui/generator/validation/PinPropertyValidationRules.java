...
public class PinPropertyValidationRules implements PropertyValidationRules {
    ...
    public PropValidationInfo getValidationInfo() {
        var mode = optional ? PropValidationInfo.PropertyValidationMode.OPTIONAL_PIN : PropValidationInfo.PropertyValidationMode.PIN;
        return new PropValidationInfo(mode, 0, 0xFFFF, null, List.of());
    }
