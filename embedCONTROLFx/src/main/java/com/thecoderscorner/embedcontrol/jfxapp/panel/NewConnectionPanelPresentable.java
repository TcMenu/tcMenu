...
public class NewConnectionPanelPresentable implements PanelPresentable<Node> {
    ...
    public NewConnectionPanelPresentable(EmbedControlContext context) {
    ...
    public NewConnectionPanelPresentable(JfxNavigationManager navigationManager, EmbedControlContext context,
                                         TcMenuPersistedConnection con, Consumer<TcMenuPersistedConnection> onUpdate) {
    ...
    public Node getPanelToPresent(double width) throws Exception {
        ...
        controller.initialise(navigationManager, context, maybeCreator, onUpdate);
        return loadedPane;
    }
