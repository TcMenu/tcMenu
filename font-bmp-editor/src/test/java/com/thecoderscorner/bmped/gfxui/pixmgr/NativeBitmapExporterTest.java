...
import com.thecoderscorner.bmped.gfxui.LoadedImage;
...
class NativeBitmapExporterTest {
    ...
    public static final PortablePalette A_MONO_PALETTE = new PortablePalette(new PortableColor[]{new PortableColor(0,0,0), new PortableColor(255,255,255)}, PortablePalette.PaletteMode.ONE_BPP);
    public static final PortablePalette A_2BPP_PALETTE = new PortablePalette(new PortableColor[]{new PortableColor(0,0,0), new PortableColor(255,255,255), new PortableColor(255,0,0), new PortableColor(0,0,255) }, PortablePalette.PaletteMode.TWO_BPP);
    ...
    void testWidgetCreation() throws IOException {
        ...
        try(var os = new ByteArrayOutputStream(); var ps = new PrintStream(os)) {
            ...
            assertThat(os.toString()).isEqualToIgnoringNewLines("""
