...
class NativeBitmapExporterTest {
    ...
    void setup() {
        ...
        when(mockedClock.instant()).thenReturn(Instant.parse("2026-06-07T00:00:00Z"));
    }

    @Test
    void testWidgetCreation() throws IOException {
        var exporter = new NativeBitmapExporter(mockedClock);
        ...
        try(var os = new ByteArrayOutputStream(); var ps = new PrintStream(os)) {
            ...
            assertThat(os.toString()).isEqualToIgnoringNewLines("""
                    // Generated by TcMenu Bitmap and Font Editor on 2026-06-07Z
