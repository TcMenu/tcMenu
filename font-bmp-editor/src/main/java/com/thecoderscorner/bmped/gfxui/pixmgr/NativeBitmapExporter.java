...
public class NativeBitmapExporter {
    ...
    public NativeBitmapExporter(Clock clock) {
        this.clock = clock;
    }
    ...
    private void outputStandardHeader(PrintStream fileOut) {
        fileOut.printf("// Generated by TcMenu Bitmap and Font Editor on %s%n", DateTimeFormatter.ISO_DATE.format(clock.instant().atZone(ZoneId.of("UTC"))));
        fileOut.println();
