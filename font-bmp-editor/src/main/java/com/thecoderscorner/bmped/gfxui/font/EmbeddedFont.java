...
import com.thecoderscorner.bmped.util.StringHelper;
...
import static com.thecoderscorner.bmped.gfxui.font.FontGlyphGenerator.FontDimensionInformation;
...
public class EmbeddedFont {
    ...
    public EmbeddedFont(byte[] dataSet) throws Exception {

        var doc = XMLDOMHelper.loadDocumentFromData(new String(dataSet, StandardCharsets.UTF_8));
    ...
    public void saveFontToStream(OutputStream out) throws Exception {
        ...
        XMLDOMHelper.writeXml(doc, out, true);
    }
    ...
    public String getDefaultFontVariableName() {
        ...
        return makeNameFromVariable(outputName);
    }
