...
public class InbuiltThemePlugins implements JavaPluginGroup {
    private final CodePluginConfig config;

    public InbuiltThemePlugins(CodePluginManager manager, VersionInfo tcMenuVersion) {
        config = new CodePluginConfig(
                "inbuilt-theme", "Inbuilt themes", tcMenuVersion.toString(), new ArrayList<>());
