...
public interface UrlsForDocumentation {
    ...
    String FLOAT_URL = MENU_MENU_ITEM_URL + "float-menu-item/";
    String BOOLEAN_URL = MENU_MENU_ITEM_URL + "boolean-menu-item/";
    String CHOICE_URL = MENU_MENU_ITEM_URL + "scrollchoice-menu-item/";
    String RGB_URL = MENU_MENU_ITEM_URL + "rgb32-menu-item/";
    String TEXT_URL = MENU_MENU_ITEM_URL + "editabletext-menu-item/";
