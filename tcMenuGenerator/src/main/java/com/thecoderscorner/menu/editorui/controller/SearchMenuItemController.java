...
public class SearchMenuItemController {
    ...
    public void init(MenuTree menuTree) {
        ...
        subColumn.setCellValueFactory(cell -> new ReadOnlyObjectWrapper<>(tree.findParent(cell.getValue()).getName()));
        itemColumn.setCellValueFactory(cell -> new ReadOnlyObjectWrapper<>(cell.getValue().getName()));
